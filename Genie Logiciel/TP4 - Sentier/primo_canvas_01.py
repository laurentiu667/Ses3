...
#             self.canevas.create_oval(bille.x - bille.taille, bille.y - bille.taille,
#                                      bille.x + bille.taille, bille.y + bille.taille, fill=bille.couleur)
#
#     def afficher_cibles(self):
#         for bille in self.modele.billes:
#             cible_x, cible_y = bille.cible
#             cible_taille = bille.taille
#             self.canevas.create_oval(cible_x - cible_taille, cible_y - cible_taille,
#                                      cible_x + cible_taille, cible_y + cible_taille, fill="grey")
#
# class Bille():
...
#         new_x = self.x + self.vitesse * self.direction_x
#         new_y = self.y + self.vitesse * self.direction_y
#
#         # Vérifier les collisions avec les bords du canvas
#         if new_x < self.taille or new_x > self.parent.largeur - self.taille:
#             self.direction_x *= -1  # Inverser la direction x
#         if new_y < self.taille or new_y > self.parent.hauteur - self.taille:
#             self.direction_y *= -1  # Inverser la direction y
#
...
#         self.vue.root.after(10, self.boucler_jeu)
#
